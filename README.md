...
🇮🇷 بخش فارسی
یک نسخه ارتقایافته، مدرن و کاملاً چالشی از بازی نوستالژیک و کلاسیک مار (Snake) که با استفاده از کتابخانه گرافیکی Tkinter در پایتون و بر پایه اصول برنامه‌نویسی شیءگرایی (OOP) طراحی و پیاده‌سازی شده است.
